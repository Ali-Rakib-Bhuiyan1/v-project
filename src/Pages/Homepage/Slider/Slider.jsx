      ...
      <Carousel className='text-left carousel'>
        <Carousel.Item>
          ...
          <Carousel.Caption className='left'>
            ...
            <h3 className='slider-title'>Fashion Accessories Decoration</h3>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption className='right'>
            ...
            <h3 className='slider-title'>JEWELRY Decoration</h3>
            <p className='slider-text'>Discount 20% Off For Ruby Members</p>
            <Button className='px-4 py-3 rounded-pill mt-4' variant='danger'>
              DISCOVER NOW
            </Button>
...
{/* 
https://i.ibb.co/wwbj9xq/slider-6804f5c5-7a22-4249-b276-44c59cc9c305-2000x.webp */}
      </Carousel>
    </div>
  );
}
